...
export const services: Service[] = [
  {
    ...
    description:
      "Мы берём на себя полную операционную ответственность за объект — стандартизируем процессы, штатную модель и качество сервиса в единой системе управления портфелем. Владельцы сохраняют прозрачность и контроль, а исполнение день в день ведёт опытная управляющая команда.",
    icon: "operations",
    outcomes: [
