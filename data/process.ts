...
export const processSteps: ProcessStep[] = [
  ...
  {
    id: "transition",
    title: "Переход в систему управления",
    description:
      "Объект переходит под единую систему управления HMS — стандартизированные SOP, штатная модель и отчётность с первого дня.",
  },
  {
    id: "revenue-rebuild",
