  ...
  return (
    <>
      <PageHeader
        ...
        description="Шесть интегрированных направлений по единой системе управления — всё, что нужно гостиничному активу для роста показателей, от ежедневных операций до вывода на рынок."
      />
