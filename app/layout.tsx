...
export const metadata: Metadata = {
  ...
  title: {
    default: `${siteConfig.name} — управляющая компания гостиничных активов`,
  ...
  keywords: [
    ...
    "revenue management",
    "гостиничные активы Санкт-Петербург",
  ...
  openGraph: {
    ...
    title: `${siteConfig.name} — управляющая компания гостиничных активов`,
    description: siteConfig.description,
  },
