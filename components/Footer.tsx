...
const serviceLinks = [
  ...
  { label: "Sales & OTA Optimization", href: "/services" },
  { label: "Hotel Launch & Opening", href: "/services" },
];
      ...
      <Container className="py-16">
        <div className="grid gap-12 lg:grid-cols-[1.4fr_1fr_1fr_1.2fr]">
          ...
          <nav className="flex flex-col gap-3">
            <h3 className="text-xs font-semibold uppercase tracking-[0.16em] text-white/70">
              Company
            </h3>
            {navLinks.map((link) => (
              <Link
        ...
        <div className="mt-14 flex flex-col items-start justify-between gap-4 border-t border-white/10 pt-8 text-xs text-muted sm:flex-row sm:items-center">
          <p>
            © {year} {siteConfig.name}. All rights reserved.
          </p>
          <p className="text-muted/80">
            Hotel management · Saint Petersburg, Russia
          </p>
        </div>
      </Container>
    </footer>
